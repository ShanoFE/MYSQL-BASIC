...
-- Opdracht 8
SELECT name, wage FROM players WHERE nationality="Brasil" OR club="Manchester City"
-- Opdracht 9
...
-- Opdracht 15
SELECT name, age, nationality FROM players WHERE nationality="Argentina" OR nationality="Brasil" AND age>"25"
